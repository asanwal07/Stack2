 ...
 * greater for 3 is 12 Next greater for 1 is 12 Next greater for 12 is -1 Next
 * greater for 6 is 8 Next greater for 8 is -1 Next greater for 7 is -1
 */

// ------>>>>>>>APPROACH

/*simple steps hai 
1.-(pop)->tb tk pop kra jb tk current element se bda element na mil jaye
2.answer->mil gya toh vhi answer hogya , stack khali hogyi pop krate krate toh answer -1 uska.
3.+(push)-last mai current element ko push krade.
 
***greater to right mai PICHE SE START KRTE HAI LOOP***
...
public class nextgreatertoright {
      ...
      public static int[] solve(int[] arr) {
            ...
            for (int i = arr.length - 2; i >= 0; i--) {
                  // ye complexity n square ni hai it seems to be but it is not because while loop
                  // is not running every time.
